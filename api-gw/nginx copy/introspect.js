...
function introspectApiKey(r) {
  ...
  if (apiKey === null || apiKey === undefined || apiKey === '') {
    ...
    // NGINX already maps to args already
    // Couldn't access it here for some reason though
  ...
  r.subrequest("/_oauth2_send_request", "apiKeyCtx=" + apiKey,
    function (reply) {
      if (reply.status === 200) {
        ...
        if (token !== null && token !== undefined && token !== '') {
          ...
          // r.variables.tokenContext = 'Bearer ' + token;
